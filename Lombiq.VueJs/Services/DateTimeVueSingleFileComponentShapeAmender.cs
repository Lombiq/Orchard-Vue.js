...
public class DateTimeVueSingleFileComponentShapeAmender : ServerSideValuesVueSingleFileComponentShapeAmenderBase
{
    ...
    public DateTimeVueSingleFileComponentShapeAmender(ILocalClock localClock, ILocalizationService localizationService)
    {
    ...
    protected override async ValueTask<object> GetPropertyValueAsync(string shapeName) =>
        new
        {
            ...
            Culture = await _localizationService.GetDefaultCultureAsync(), // Same as "@Orchard.CultureName()".
        };
}
