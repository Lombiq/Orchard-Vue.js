...
var DemoOptions = function DemoOptions () {};

var staticAccessors = { antiForgeryToken: { configurable: true },text: { configurable: true } };

staticAccessors.antiForgeryToken.get = function () {
    return Vue.config.demoApp.antiForgeryToken;
};

staticAccessors.text.get = function () {
    return Vue.config.demoApp.text;
};

Object.defineProperties( DemoOptions, staticAccessors );
