...
namespace Lombiq.VueJs.Samples.Controllers
{
    ...
    public class VueSfcController : Controller
    {
        ...
        // This method returns JSON, providing an API equivalent for the EnhancedList action. The enhanced app will use
        // that to update results asynchronously. Both use the same source of data.
